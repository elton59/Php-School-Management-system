...
<div class="content-wrapper">
  ...
  <div class="row">
    ...
    <div class="panel panel-success">
        ...
        <div class="panel-heading"><center>funds</center></div>
           <div class="col-sm-6">
</div>
...
if(isset($_POST['search']))
{
    if( isset($_GET['school_name']))
   {
    ...
    ?>
         ...
         <table id="fundi" class="table table-responsive ps ">
                      <thead>
                        <tr><th>ID</th><th>SCHOOLNAME</th><th>PROJECT NAME</th><th>AMOUNT</th><th>DESCRIPTION</th><th>PROJECT2_NAME</th><th>AMOUNT</th><th>DESCRIPTION</th><th>REG_DATE</th><th>STATUS</th><th>ACTION</th></tr>
                      </thead>
                  ...
                  while($row=$result->fetch_assoc())
                  {
                    ...
                    <td>".$row['reg_date']."</td>
                      <td>".$row['status']."</td>
                   <td> <a href='fundi.php?asid=$row[id]' class='btn btn-info'>Disbursed<a>
  ...
  {
    $id=$_GET['asid'];
    $result=$mysqli->query("UPDATE fundding SET status='disbursed'  where id='$id'")or die($mysqli->error);
...
function fnExcelReport()
{
    ...
    tab = document.getElementById('fundi'); // id of table
