...
<div class="content-wrapper">
  ...
  <div class="row">
    ...
    <div class="panel panel-success">
        ...
        <div class="panel-heading"><center>Special Education</center></div>
           <div class="col-sm-6">
</div>
...
if(isset($_POST['search']))
{
    if( isset($_GET['school_name']))
   {
    ...
    ?>
         ...
         <table id="speci" class="table table-responsive ps ">
                      <thead>
                        <tr><th>ID</th><th>SCHOOL NAME</th><th>STUDENT</th><th>SPECIAL</th><th>BOOKS</th><th>AOB</th><th>REGDATE</th><th>STATUS</th>><th>ACTION</th></tr>
                      </thead>
                  ...
                  while($row=$result->fetch_assoc())
                  {
                    ...
                    <td>".$row['reg_date']."</td>
                      <td>".$row['status']."</td>
                   <td> <a href='speci.php?asid=$row[id]' class='btn btn-info'>Disbursed<a>
  ...
  {
    $id=$_GET['asid'];
    $result=$mysqli->query("UPDATE request SET status='disbursed'  where id='$id'")or die($mysqli->error);
    
  }   
   if(isset($_GET['rjsid']))
  {
    $id=$_GET['rjsid'];
    $result=$mysqli->query("UPDATE request SET status='rejected'  where id='$id'")or die($mysqli->error);
...
function fnExcelReport()
{
    ...
    tab = document.getElementById('speci'); // id of table
