    ...
    if(isset($_POST['signup']))
       {
        ...
        $result=$mysqli->query("INSERT INTO headteacher (firstName,LastName,SchoolName,Email,Password) VALUES('$fname','$lname','$sname',
            ...
            <div class="container">
                <div class="signup-content">
                    ...
                    <form method="POST" id="signup-form" class="signup-form">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-input" name="sname" id="sname" placeholder="SchoolName"/>
