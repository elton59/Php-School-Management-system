...
<title>Headteachers portal</title>
...
<span class="icon-bar"></span>
 ...
 HEADTEACHERS PORTAL</span></a></div>
...
<span class="glyphicon glyphicon-user padding-right-small" style="position:relative;top: 3px;"></span> HD ACCOUNT                  
...
<li class="divider"></li>
 ...
 <li class="dropdown-header">HD Panel</li>             
<li class="divider"></li>
...
<span class="label label-info">+3</span></a></li>
    ...
    <li ><a href="staff.php"><span class="fa fa-caret-right"></span> Report from QSA </a></li>
    </ul></li>

    <li><ul class="dashboard-menu nav nav-list collapse in">
<li><a href="#" data-target=".accounts-menu" class="nav-header collapsed" data-toggle="collapse"><i class="fa fa-fw fa-briefcase"></i> Exammination  
<span class="label label-info">+3</span></a></li>

<li ><a href="exams.php"><span class="fa fa-caret-right"></span> Exammination Scheduling </a></li>
<li ><a href="results.php"><span class="fa fa-caret-right"></span> Secondary schools Results </a></li>
<li ><a href="prim.php"><span class="fa fa-caret-right"></span> Primary schools Results </a></li>
    </ul></li>
