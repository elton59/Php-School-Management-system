...
if(isset($_POST['search']))
{
    ...
    ?>
         ...
         <table id="example1" class="table table-responsive ps ">
          <h1> Fund Allocation</h1>
                      <thead>
                        <tr><th> SCHOOL_NAME</th><th>SCHOOL_CODE</th><th>NUMBER OF STUDENTS</th><th>AMOUNT TO BE ALLOCATED</th><th>REGDATE</th><th>STATUS</th><th>ACTION</th></tr>
                      </thead>
                  ...
                  while($row=$result->fetch_assoc())
                  {
                    ...
                    <td>".$row['reg_date']."</td>
                    <td>".$row['status']."</td>
                    <td> <a href='funds.php?rsf=$row[school_name]' class='btn btn-info'>Received<a>
                   </td>
  ...
  {
    $id=$_GET['rsf'];
    $result=$mysqli->query("UPDATE funds SET STATUS='received'  where school_name='$id'")or die($mysqli->error);
