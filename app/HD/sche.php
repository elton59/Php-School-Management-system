...
<li><a href="faq.html" class="nav-header"><i class="fa fa-fw fa-comment"></i> Faq</a></li>
    ...
    <div class="content">
<div class="header"> 
            <h1 class="page-title">SCHOOL EVENTS DATES</h1>
...
echo "<td>".$row['venue_1']."</td>";
echo "<td>".$row['date_2_1']."</td>";
echo "<td>".$row['date_2_2']."</td>";
echo "<td>".$row['venue_2']."</td>";
echo "<td>".$row['date_3_1']."</td>";
echo "<td>".$row['date_3_2']."</td>";
echo "<td>".$row['venue_3']."</td>";
