...
if(isset($_POST['search']))
{
    if( isset($_GET['school_name']))
   {
    ...
    ?>
         ...
         <table id="example1" class="table table-responsive ps ">
                      <thead>
                        <tr><th>ID</th><th>SCHOOL NAME</th><th>NO OF STUDENTS</th><th>NO OFSPECIA MATERIALS ALLOCATEDL</th><th>BOOKS</th><th>AOB</th><th>REGDATE</th><th>STATUS</th><th>ACTION</th></tr>
                      </thead>
                  ...
                  while($row=$result->fetch_assoc())
                  {
                    ...
                    <td>".$row['reg_date']."</td>
                      <td>".$row['status']."</td>
                   <td> <a href='speci.php?asid=$row[id]' class='btn btn-info'>Received<a>
                   </td>
  ...
  {
    $id=$_GET['asid'];
    $result=$mysqli->query("UPDATE request SET status='received'  where id='$id'")or die($mysqli->error);
