...
<ul style="list-style-type:disc;">
  ...
  <p>Primary Schools Funds Allocations 2020/2021</p>
  <table>
          <tr>
              <th>Schools Name</th>
              <th>School code </th>
...
<select name="schools" id="schools">
  ...
  <option value="Rang'ala Boys primary school"> Rang'ala Boys primary school</option>
...
<p>Secondary Schools Funds Allocations 2020/2021</p>
      <table>
          <tr>
              <th>Schools Name</th>
              <th>School code </th>
...
<td>
<select name="schools" id="schools">
  <option value="St. Francis Rang'ala Girls Secondary"> St. Francis Rang'ala Girls Secondary</option>
  <option value="Rang'ala Boys Secondary"> Rang'ala Boys Secondary</option>
  ...
  <option value="St. Paul's Sigomre Secondary Sch"> St. Paul's Sigomre Secondary Sch</option>
  <option value="Gospel Mission Academy Secondary"> Gospel Mission Academy Secondary</option>
</select></td>
    <td><input type="number" name="code_2" ></td>
    <td><input type="number" name="student_2" ></td>
