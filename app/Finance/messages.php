  ...
  <div class="row">
    ...
    <div class="panel panel-success">
        ...
        <form style="background-image:url('hand.jpg')" method="POST" action="sendm.php">
            ...
            <label>Role</label>
            <input type="text" name="role" value="FinanceManager"  readonly/>
        ...
        <div class="panel-body">
         ...
         <table id="sport" class="table table-responsive ps ">
                      ...
                      <?php
                  $result=$mysqli->query("select * from feedback where  sentfrom='FinanceManager'")or die($mysqli->error);
     ...
     <button onclick="fnExcelReport()" class="btn btn-success" >Export to Excel</a></td>
      ...
      <div class="table-responsive ps">
         ...
         <table id="sport" class="table table-responsive ps ">
                      ...
                      <?php
                  $result=$mysqli->query("select * from feedback where  sentto='FinanceManager'")or die($mysqli->error);
                  $row=$result->fetch_assoc();
                  while($row=$result->fetch_assoc())
                  {
