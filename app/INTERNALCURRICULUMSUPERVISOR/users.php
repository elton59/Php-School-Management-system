 ...
 <input type="submit" name="search" value="search data">
         ...
         <table id="example1" class="table table-responsive ps ">
                  ...
                  while($row=$result->fetch_assoc())
                  {
                   ...
                   <a href='users.php?rjhid=$row[email]' class='btn btn-danger'>Reject<a></td>
                   </tbody>
                    "
                  ;}
...
<div class="table-responsive ps">
         ...
         <table id="example" class="table table-responsive ps ">
                      <thead>
                  ...
                  while($row=$result->fetch_assoc())
                  {
                    ...
                    <td>".$row['LastName']."</td>
                    <td>".$row['status']."</td>  
                   <td> <a href='users.php?afid=$row[email]' class='btn btn-info'>Approve<a>
                   <a href='users.php?rjfid=$row[email]' class='btn btn-danger'>Reject<a></td>
                   </tbody>
                    "
                  ;}
...
<div class="table-responsive ps">
         ...
         <table id="example1" class="table table-responsive ps ">
                  ...
                  while($row=$result->fetch_assoc())
                  {
                    ...
                    <td>".$row['status']."</td>  
                   <td> <a href='users.php?aqid=$row[email]' class='btn btn-info'>Approve<a>
                   <a href='users.php?rjqid=$row[email]' class='btn btn-danger'>Reject<a></td>
                   </tbody>
                    "
                  ;}
